...
@@ -13,21 +13,22 @@ function testPartition(classifierConst, options, trainSet, testSet) {
...
@@ -36,7 +37,10 @@ module.exports = function crossValidate(classifierConst, options, data, k) {
     trainTime : 0,
     testTime : 0,
     iterations: 0,
-    trainError: 0
...
+    recall: 0
   ...
   var misclasses = [];
@@ -46,7 +50,7 @@ module.exports = function crossValidate(classifierConst, options, data, k) {
...
+    var result = testPartition(classifierConst, options, trainSet, testSet, errorThresh);
     ...
     _(avgs).each(function(sum, i) {
       avgs[i] = sum + result[i];
@@ -66,4 +70,4 @@ module.exports = function crossValidate(classifierConst, options, data, k) {
     avgs: avgs,
...
@@ -92,7 +93,8 @@ NeuralNetwork.prototype = {
...
@@ -165,7 +167,7 @@ NeuralNetwork.prototype = {
       }
...
@@ -175,45 +177,92 @@ NeuralNetwork.prototype = {
       }
       data = data.map(function(datum) {
